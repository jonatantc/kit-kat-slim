...
namespace kit_kat
{
    public partial class MainForm : Form
    {
        ...
        private void Form1_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            File.Delete(Path.Combine(Path.GetTempPath(), "MakeRom.exe"));
            #endregion
        ...
        #endregion
        #region Custom Theme Panel Events
        private void panelColor_Click(object sender, EventArgs e) { ColorPicker("WindowColorPanel"); }
        private void panel20_Click(object sender, EventArgs e) { ColorPicker("HighlightColorPanel"); }
        private void WindowColorPanel2_Click(object sender, EventArgs e) { ColorPicker("WindowColorPanel"); }
        private void TabBackgroundColorPanel_Click(object sender, EventArgs e) { ColorPicker("TabBackgroundColorPanel"); }
        private void customLabel25_Click(object sender, EventArgs e) { ColorPicker("TextColorPanel"); }
        #endregion
        ...
        private void materialButton1_Click_1(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(fbd.SelectedPath))
            {
                ...
                ProcessStartInfo p3 = new ProcessStartInfo(Path.Combine(Path.GetTempPath(), "MakeRom.exe"));
                p3.Verb = "runas";
                p3.WorkingDirectory = fbd.SelectedPath;
                p3.UseShellExecute = false;
                p3.CreateNoWindow = true;
                ...
                else
                {
                    ...
                    string arg2 = "";
                    string arg3 = "";
                    if (File.Exists(fbd.SelectedPath+"/CustomPartition0.bin")) { arg1 = "-content CustomPartition0.bin:0:0x00"; }
                    if (File.Exists(fbd.SelectedPath + "/CustomPartition1.bin")) { arg2 = "-content CustomPartition1.bin:1:0x01"; }
                    if (File.Exists(fbd.SelectedPath + "/CustomPartition2.bin")) { arg3 = "-content CustomPartition2.bin:2:0x02"; }
                    
                    log("Rebuilding .cia Rom...", "logger4");
                    sb = new StringBuilder();
                    sb.Append("-f cia "+arg1+" "+arg2+" "+arg3+" -minor "+minorv+" -micro "+microv+" -o Rebuilt.cia");
                    p3.Arguments = sb.ToString().Replace(',', '.');
                    Process.Start(p3).WaitForExit();

                    log("Rebuilt the .cia rom to '" + fbd.SelectedPath + "'.", "logger4", "Success");
